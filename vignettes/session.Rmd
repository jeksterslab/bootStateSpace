...
#> [31] Formula_1.2-5       pracma_2.4.4        mice_3.17.0        
...
#> [43] boot_1.3-31         rProject_0.0.18     mclust_6.1.1       
#> [46] foreach_1.5.2       mitml_0.4-5         nlme_3.1-166       
#> [49] tidyselect_1.2.1    mvtnorm_1.3-3       stringi_1.8.4      
#> [52] dplyr_1.1.4         reshape2_1.4.4      purrr_1.0.4        
#> [55] splines_4.4.2       pcaPP_2.0-5         latex2exp_0.9.6    
#> [58] grid_4.4.2          colorspace_2.1-1    expm_1.0-0         
#> [61] cli_3.6.3.9002      magrittr_2.0.3      survival_3.7-0     
#> [64] broom_1.0.7         scales_1.3.0        backports_1.5.0    
#> [67] dynr_0.1.16-109     nnet_7.3-19         lme4_1.1-36        
#> [70] deSolve_1.40        evaluate_1.0.3      knitr_1.49         
#> [73] rbibutils_2.3       rlang_1.1.5         Rcpp_1.0.14        
#> [76] hdrcde_3.4          xtable_1.8-4        glue_1.8.0         
#> [79] fda_6.2.0           minqa_1.2.8         R6_2.5.1           
#> [82] plyr_1.8.9
```
...
#> bitops            "bitops"            "1.0-9"      
#> blob              "blob"              "1.2.4"      
#> bootStateSpace    "bootStateSpace"    "1.0.1"      
#> brew              "brew"              "1.0-10"     
#> brio              "brio"              "1.1.5"      
#> broom             "broom"             "1.0.7"      
#> bslib             "bslib"             "0.8.0"      
...
#> Mem:            23Gi       6.6Gi       4.0Gi       1.2Gi        14Gi        16Gi
#> Swap:           11Gi          0B        11Gi
#> Total:          34Gi       6.6Gi        15Gi
```
