...
#> [13] parallel_4.5.2      tibble_3.3.0        cluster_2.1.8.1    
#> [16] pan_1.9             pkgconfig_2.0.3     fds_1.8            
#> [19] jomo_2.7-6          Matrix_1.7-4        KernSmooth_2.23-26 
#> [22] RColorBrewer_1.1-3  S7_0.2.1            lifecycle_1.0.4    
#> [25] compiler_4.5.2      farver_2.1.2        stringr_1.6.0      
#> [28] codetools_0.2-20    carData_3.0-5       rainbow_3.8        
#> [31] RCurl_1.98-1.17     glmnet_4.1-10       Formula_1.2-5      
#> [34] pracma_2.4.6        mice_3.19.0         car_3.1-3          
#> [37] pillar_1.11.1       nloptr_2.2.1        tidyr_1.3.2        
#> [40] MASS_7.3-65         reformulas_0.4.3    iterators_1.0.14   
#> [43] abind_1.4-8         rpart_4.1.24        boot_1.3-32        
#> [46] rProject_0.0.23     mclust_6.1.2        foreach_1.5.2      
#> [49] mitml_0.4-5         nlme_3.1-168        tidyselect_1.2.1   
#> [52] mvtnorm_1.3-3       stringi_1.8.7       dplyr_1.1.4        
#> [55] reshape2_1.4.5      purrr_1.2.0         splines_4.5.2      
...
#> [67] scales_1.4.0        backports_1.5.0     dynr_0.1.16-114    
#> [70] otel_0.2.0          nnet_7.3-20         lme4_1.1-38        
#> [73] deSolve_1.40        evaluate_1.0.5      knitr_1.51         
#> [76] rbibutils_2.4       rlang_1.1.6         Rcpp_1.1.0         
#> [79] hdrcde_3.4          xtable_1.8-4        glue_1.8.0         
#> [82] fda_6.3.0           minqa_1.2.8         R6_2.6.1           
#> [85] plyr_1.8.9
```
...
## Memory
    ...
    #> Mem:           125Gi        10Gi        22Gi       5.3Gi        99Gi       115Gi
    #> Swap:             0B          0B          0B
    #> Total:         125Gi        10Gi        22Gi
